          ...
          <div className="flex flex-col items-start lg:items-end gap-3">
            ...
            <div className="hidden lg:flex items-stretch gap-3">
              {[
                ...
                <div key={s.label} className="bg-white border text-center border-slate-200 rounded-3xl px-5 shadow-sm flex flex-col justify-center min-w-25">
              ...
              <div className="bg-slate-900 rounded-3xl px-6 py-4 text-white shadow-md relative overflow-hidden flex items-center justify-between min-w-65 ml-1 text-left border border-slate-800">
                ...
                <div className="z-10 relative">
                  <p className="text-[10px] font-bold text-blue-400 uppercase tracking-widest mb-1.5">{t('check_status_title')}</p>
                  <p className="text-xl font-black tracking-tight">{t('check_status_ok')}</p>
                </div>
