      ...
      <section className="max-w-4xl mx-auto px-4 py-14 space-y-6">
        ...
        <div className="rounded-2xl border border-slate-200 p-6 bg-slate-50 space-y-2">
          <p className="text-sm text-slate-700">
            <span className="font-semibold">{t("contact_helpline")}:</span> 1930
          </p>
          <p className="text-sm text-slate-700">
            <span className="font-semibold">{t("contact_portal")}:</span>{" "}
            cybercrime.gov.in
          </p>
          <p className="text-sm text-slate-700">
            <span className="font-semibold">{t("contact_email")}:</span>{" "}
            support@scamshield.in
          </p>
        </div>
      </section>
    </main>
