            ...
            <div className="bg-gradient-to-r from-violet-600 to-indigo-600 p-5">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-white font-bold text-base">
                      Fraud Incident Timeline Builder
                    </h3>
                    <p className="text-violet-200 text-xs">
                      Generates a legal-ready cybercrime complaint summary
                    </p>
                  </div>
                </div>
                <button
              ...
              <div className="flex justify-between mt-1">
                {["When?", "What happened?", "Details"].map((label, i) => (
                  <span
                    key={label}
                    className={`text-[10px] font-semibold ${step >= i + 1 ? "text-white" : "text-white/40"}`}
                  >
                    {label}
                  </span>
                ))}
                ...
                {step === 1 && (
                  ...
                  >
                    ...
                    <p className="text-xs text-slate-400 mt-2">
                      If unsure, enter an approximate time or skip to Step 3 and
                      describe it
                    </p>
        ...
        {result && (
          ...
          >
            ...
            <div className="bg-gradient-to-r from-violet-600 to-indigo-600 p-5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-violet-200 text-xs">
                    Ready to paste into cybercrime.gov.in
                  </p>
                </div>
              </div>
              <div
                className={`text-xs font-bold px-2 py-1 rounded border ${urgencyColor(result.urgency)}`}
              >
            ...
            <div className="p-6 space-y-4">
              {/* Urgency notice */}
              <div
                className={`flex items-center gap-2 p-3 rounded-xl border ${urgencyColor(result.urgency)}`}
              >
