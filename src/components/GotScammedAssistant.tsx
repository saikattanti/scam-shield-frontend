...
export default function GotScammedAssistant({ defaultOpen = true }: Props) {
  ...
  return (
    <div
      className={`flex flex-col lg:flex-row gap-6 w-full ${result ? "items-start" : "items-stretch"}`}
    >
          ...
          <div className="space-y-7 relative z-10">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                {[
                  ...
                  {
                    label: "Bank OTP",
                    text: "Someone called from SBI and asked for my OTP to update KYC. I gave it and ₹12,000 was debited.",
                    platform: "SBI",
                    amount: "12000",
                  },
                  {
            ...
            <div className="flex justify-center pt-2">
              <SlideArrowButton
                ...
                text={
                  loading
                    ? t("form_generating_recovery")
                    : t("form_generate_recovery")
                }
                primaryColor="#dc2626"
        ...
        <AnimatePresence mode="wait">
          ...
          {isIdle && (
            ...
            >
              ...
              <h3 className="text-3xl font-black text-slate-800 mb-3 tracking-tight">
                {t("form_need_help_now")}
              </h3>
              <p className="text-sm text-slate-500 max-w-[400px] mb-10 leading-relaxed">
                Provide the details of your incident on the left. The Gemini AI
                engine will analyze exactly what type of scam it was, and
                instantly generate a 1-2-3 recovery protocol including official
                helpline numbers, app-specific blocking instructions, and legal
                reporting links.
              </p>
            </motion.div>
          )}
            ...
            >
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-black text-slate-800 mb-3">
                  {t("form_analyzing_recovery")}
                </h3>
                <p className="text-sm text-slate-500 mb-10 max-w-sm mx-auto">
                  Gemini is pulling the exact reporting pipelines for your
                  specific scam vector...
                </p>
              </div>
            </motion.div>
          )}
          ...
          {result && !loading && (
            ...
            >
              ...
              >
                <div
                  className={`bg-red-500 px-10 py-8 text-white relative flex flex-col md:flex-row md:items-center justify-between gap-6 overflow-hidden`}
                >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 text-white font-medium text-sm pt-2 tracking-wide">
                        <span className="opacity-80">
                          {t("form_scam_classification")}:
                        </span>{" "}
                        <span className="font-bold">
                          {result.scamType?.replace(/_/g, " ")}
                        </span>
                        {result.platform && (
                          <span className="opacity-80 ml-2">via</span>
                        )}
                        {result.platform && (
                ...
                <div className="p-8 pb-10 bg-white">
                  ...
                  {result.firDraft && (
                    <div className="mt-8 mb-2">
                      <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-4 pl-1">
                        Pre-filled Police Complaint (Copy Code)
                      </p>
                      <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 relative group">
                        <button
                          onClick={() =>
                            navigator.clipboard.writeText(result.firDraft || "")
                          }
